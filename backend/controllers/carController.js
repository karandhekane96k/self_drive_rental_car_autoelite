...
export const createCar = async (req, res) => {
  try {
    const { name, brand, image, dailyRate, transmission, seats } = req.body;
    
    const car = await Car.create({
      name, brand, image, dailyRate, transmission, seats
    });
...
// @desc    Update car details (Name, Brand, Daily Rate, Transmission, Seats, Image)
...
export const updateCar = async (req, res) => {
  try {
    ...
    // Update image path if a new one was uploaded
    if (image) {
      car.image = image;
    }
